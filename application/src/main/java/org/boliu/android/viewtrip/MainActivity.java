...
package org.boliu.android.viewtrip;
...
import org.boliu.android.viewtrip.session.SessionDetailActivity;
...
public class MainActivity extends BaseActivity {
    ...
    private static class State {
        ...
        State(int background, int map, Item[] items) {
    ...
    private static class Item {
        ...
        public Item(int photo, String videoLink) {
            this.photo = photo;
            this.videoLink = videoLink;
        }

        public Item(int photo) {
            this.photo = photo;
        }
    }

    private Item[] az_items = {new Item(R.drawable.photo_01_antelope, "https://www.youtube.com/watch?v=de3n9j1wuzM"),
            new Item(R.drawable.photo_09_horseshoe),
            new Item(R.drawable.photo_10_sky)};
    private Item[] ut_items = { new Item(R.drawable.photo_08_arches),
            new Item(R.drawable.photo_03_bryce),
            new Item(R.drawable.photo_04_powell)};
    private Item[] ca_items = { new Item(R.drawable.photo_07_san_francisco),
            new Item(R.drawable.photo_02_tahoe),
            new Item(R.drawable.photo_05_sierra),
            new Item(R.drawable.photo_06_rockaway)};

    private final State[] mStates = {
            new State(R.color.az, R.raw.map_az, az_items),
            new State(R.color.ut, R.raw.map_ut, ut_items),
            new State(R.color.ca, R.raw.map_ca, ca_items),
    };
    ...
    private void addState(LayoutInflater inflater, LinearLayout container, final State state) {
        ...
        for (int i = 0; i < state.bitmaps.size(); i++) {
            Bitmap b = state.bitmaps.get(i);
            final String videoLink = state.items[i].videoLink;
...
//                            "here :" + videoLink == null ? "" : videoLink ,
//                            Toast.LENGTH_SHORT).show();
                    sessionDetailItemClicked(image);
                }
            });
